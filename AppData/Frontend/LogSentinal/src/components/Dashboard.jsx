  ...
  return(
    <div className="fixed inset-0 -z-10 bg-[#080c14] font-['Space_Grotesk']" style={{backgroundImage: 'radial-gradient(circle, #d7e4dd22 1px, transparent 1px)', backgroundSize: '24px 24px'}} >
      ...
      <div className="flex flex-col h-screen">
        ...
        {/* Header */}
        <Header currentRoom={currentRoom} setCurrentRoom={setCurrentRoom} rooms={rooms} setView={setView} view={view[currentRoom]} socket={socket} from={from} to={to} setSummary={setSummary} setContact={setContact}/>
